<template>
  <el-card>
    <div>
      <el-form :model="frame" :rules="rules" ref="frame" @submit.native.prevent>
        <el-row style="margin-bottom: 20px">
          <el-col :span="5"> </el-col>

          <el-col :span="7">
            <el-form-item label="門框名稱:" label-width="100px" prop="specid">
              <el-input
                placeholder="請輸入門框名稱"
                v-model="frame.specid"
              ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <el-button type="primary" @click="submitForm('frame')">確認</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        specid: [{ required: true, message: "請輸入門框名稱" }]
      }
    };
  },
